...
# GURTARAN SINGH - 102003220

# Tic-Tac-Toe Game (Human v/s AI)

# The project aims to demonstrate the use of the Mini-Max algorithm along with Alpha-Beta pruning for playing the game. 
# We have used python's PyGame library to make a user-friendly interface. 
# The player who gets three X's or three O's in a particular row, column or diagonal first wins the game. 
